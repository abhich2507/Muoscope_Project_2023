...
// Mon Jun 26 21:37:50 2023 by ROOT version 6.26/06
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         GenPartPhi;
   Int_t           NScintHit;
   Int_t           ScintHitPrimaryID[83];   //[NScintHit]
   Int_t           ScintHitTrackID[83];   //[NScintHit]
   Int_t           ScintHitTrackLength[83];   //[NScintHit]
   Float_t         ScintHitE[83];   //[NScintHit]
   Float_t         ScintHitPz[83];   //[NScintHit]
   Float_t         ScintHitPosX[83];   //[NScintHit]
   Float_t         ScintHitPosY[83];   //[NScintHit]
   Float_t         ScintHitPosZ[83];   //[NScintHit]
   Int_t           ScintHitStation[83];   //[NScintHit]
   Int_t           HitPDG[83];   //[NScintHit]
