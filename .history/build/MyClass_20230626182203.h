...
// Mon Jun 26 18:21:53 2023 by ROOT version 6.26/06
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           NScintHit;
   Int_t           ScintHitPrimaryID[4551];   //[NScintHit]
   Int_t           ScintHitTrackID[4551];   //[NScintHit]
   Int_t           ScintHitTrackLength[4551];   //[NScintHit]
   Float_t         ScintHitE[4551];   //[NScintHit]
   Float_t         ScintHitPz[4551];   //[NScintHit]
   Float_t         ScintHitPosX[4551];   //[NScintHit]
   Float_t         ScintHitPosY[4551];   //[NScintHit]
   Float_t         ScintHitPosZ[4551];   //[NScintHit]
   Int_t           ScintHitStation[4551];   //[NScintHit]
   Int_t           HitPDG[4551];   //[NScintHit]
