...
// Mon Jun 26 22:10:05 2023 by ROOT version 6.26/06
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         GenPartPhi;
   Int_t           NScintHit;
   Int_t           ScintHitPrimaryID[1066];   //[NScintHit]
   Int_t           ScintHitTrackID[1066];   //[NScintHit]
   Int_t           ScintHitTrackLength[1066];   //[NScintHit]
   Float_t         ScintHitE[1066];   //[NScintHit]
   Float_t         ScintHitPz[1066];   //[NScintHit]
   Float_t         ScintHitPosX[1066];   //[NScintHit]
   Float_t         ScintHitPosY[1066];   //[NScintHit]
   Float_t         ScintHitPosZ[1066];   //[NScintHit]
   Int_t           ScintHitStation[1066];   //[NScintHit]
   Int_t           HitPDG[1066];   //[NScintHit]
