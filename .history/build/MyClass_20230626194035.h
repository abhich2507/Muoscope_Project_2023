...
// Mon Jun 26 19:40:24 2023 by ROOT version 6.26/06
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           NScintHit;
   Int_t           ScintHitPrimaryID[324];   //[NScintHit]
   Int_t           ScintHitTrackID[324];   //[NScintHit]
   Int_t           ScintHitTrackLength[324];   //[NScintHit]
   Float_t         ScintHitE[324];   //[NScintHit]
   Float_t         ScintHitPz[324];   //[NScintHit]
   Float_t         ScintHitPosX[324];   //[NScintHit]
   Float_t         ScintHitPosY[324];   //[NScintHit]
   Float_t         ScintHitPosZ[324];   //[NScintHit]
   Int_t           ScintHitStation[324];   //[NScintHit]
   Int_t           HitPDG[324];   //[NScintHit]
