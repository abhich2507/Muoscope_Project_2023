...
// Mon Jun 26 21:28:29 2023 by ROOT version 6.26/06
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         GenPartPhi;
   Int_t           NScintHit;
   Int_t           ScintHitPrimaryID[59];   //[NScintHit]
   Int_t           ScintHitTrackID[59];   //[NScintHit]
   Int_t           ScintHitTrackLength[59];   //[NScintHit]
   Float_t         ScintHitE[59];   //[NScintHit]
   Float_t         ScintHitPz[59];   //[NScintHit]
   Float_t         ScintHitPosX[59];   //[NScintHit]
   Float_t         ScintHitPosY[59];   //[NScintHit]
   Float_t         ScintHitPosZ[59];   //[NScintHit]
   Int_t           ScintHitStation[59];   //[NScintHit]
   Int_t           HitPDG[59];   //[NScintHit]
