...
void MyClass::Loop()
{
   ...
   TH1F *histAngleXZ = new TH1F("histAngleXZ", "scattering angleXZ", 200, -0.018, 0.02);
   TH1F *histAngleYZ = new TH1F("histAngleYZ", "scattering angleYZ", 200, -0.02, 0.02);
