...
void MyClass::Loop()
{
   ...
   TH1F *histAngleXZ = new TH1F("histAngleXZ", "scattering angleXZ", 1000, -0.1, 0.1);
   TH1F *histAngleYZ = new TH1F("histAngleYZ", "scattering angleYZ", 1000, -0.1, 0.1);
   TH1F *histAngle = new TH1F("histAngle", "scattering angle", 1000, 0.0001, 0.5);
