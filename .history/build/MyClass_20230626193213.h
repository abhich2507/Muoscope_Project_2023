...
// Mon Jun 26 19:31:56 2023 by ROOT version 6.26/06
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           NScintHit;
   Int_t           ScintHitPrimaryID[1787];   //[NScintHit]
   Int_t           ScintHitTrackID[1787];   //[NScintHit]
   Int_t           ScintHitTrackLength[1787];   //[NScintHit]
   Float_t         ScintHitE[1787];   //[NScintHit]
   Float_t         ScintHitPz[1787];   //[NScintHit]
   Float_t         ScintHitPosX[1787];   //[NScintHit]
   Float_t         ScintHitPosY[1787];   //[NScintHit]
   Float_t         ScintHitPosZ[1787];   //[NScintHit]
   Int_t           ScintHitStation[1787];   //[NScintHit]
   Int_t           HitPDG[1787];   //[NScintHit]
