               ...
               for (int i = 0; i < NScintHit; i++)
               {
                  if (abs(HitPDG[i]) == 13)
                  {
                     ...
                     if (ScintHitStation[i] == j)
                     {
                        ...
                        E += ScintHitE[i];
                        if (j==2){
                         histogram2->Fill(ScintHitPosX[i], ScintHitPosY[i]);
                     }
