...
// Mon Jun 26 21:57:22 2023 by ROOT version 6.26/06
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         GenPartPhi;
   Int_t           NScintHit;
   Int_t           ScintHitPrimaryID[685];   //[NScintHit]
   Int_t           ScintHitTrackID[685];   //[NScintHit]
   Int_t           ScintHitTrackLength[685];   //[NScintHit]
   Float_t         ScintHitE[685];   //[NScintHit]
   Float_t         ScintHitPz[685];   //[NScintHit]
   Float_t         ScintHitPosX[685];   //[NScintHit]
   Float_t         ScintHitPosY[685];   //[NScintHit]
   Float_t         ScintHitPosZ[685];   //[NScintHit]
   Int_t           ScintHitStation[685];   //[NScintHit]
   Int_t           HitPDG[685];   //[NScintHit]
