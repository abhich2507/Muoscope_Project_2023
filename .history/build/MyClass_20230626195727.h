...
// Mon Jun 26 19:57:14 2023 by ROOT version 6.26/06
...
Vector3D findPointOfClosestApproach(const Vector3D& v1, const Vector3D& v2) {
    Vector3D delta = {v1.x - v2.x, v1.y - v2.y, v1.z - v2.z};
    double dotProduct = v1.x * v2.x + v1.y * v2.y + v1.z * v2.z;

    double t = -dotProduct / (delta.x * delta.x + delta.y * delta.y + delta.z * delta.z);

    Vector3D pointOfClosestApproach1 = {v1.x + t * delta.x, v1.y + t * delta.y, v1.z + t * delta.z};
    Vector3D pointOfClosestApproach2 = {v2.x + t * delta.x, v2.y + t * delta.y, v2.z + t * delta.z};

    Vector3D pointOfClosestApproach = (pointOfClosestApproach1 + pointOfClosestApproach1)/2. ;

    return pointOfClosestApproach;
}
*/
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           NScintHit;
   Int_t           ScintHitPrimaryID[69433];   //[NScintHit]
   Int_t           ScintHitTrackID[69433];   //[NScintHit]
   Int_t           ScintHitTrackLength[69433];   //[NScintHit]
   Float_t         ScintHitE[69433];   //[NScintHit]
   Float_t         ScintHitPz[69433];   //[NScintHit]
   Float_t         ScintHitPosX[69433];   //[NScintHit]
   Float_t         ScintHitPosY[69433];   //[NScintHit]
   Float_t         ScintHitPosZ[69433];   //[NScintHit]
   Int_t           ScintHitStation[69433];   //[NScintHit]
   Int_t           HitPDG[69433];   //[NScintHit]
