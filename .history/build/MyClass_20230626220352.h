...
// Mon Jun 26 22:03:30 2023 by ROOT version 6.26/06
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         GenPartPhi;
   Int_t           NScintHit;
   Int_t           ScintHitPrimaryID[136];   //[NScintHit]
   Int_t           ScintHitTrackID[136];   //[NScintHit]
   Int_t           ScintHitTrackLength[136];   //[NScintHit]
   Float_t         ScintHitE[136];   //[NScintHit]
   Float_t         ScintHitPz[136];   //[NScintHit]
   Float_t         ScintHitPosX[136];   //[NScintHit]
   Float_t         ScintHitPosY[136];   //[NScintHit]
   Float_t         ScintHitPosZ[136];   //[NScintHit]
   Int_t           ScintHitStation[136];   //[NScintHit]
   Int_t           HitPDG[136];   //[NScintHit]
