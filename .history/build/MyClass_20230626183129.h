...
// Mon Jun 26 18:31:19 2023 by ROOT version 6.26/06
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           NScintHit;
   Int_t           ScintHitPrimaryID[996];   //[NScintHit]
   Int_t           ScintHitTrackID[996];   //[NScintHit]
   Int_t           ScintHitTrackLength[996];   //[NScintHit]
   Float_t         ScintHitE[996];   //[NScintHit]
   Float_t         ScintHitPz[996];   //[NScintHit]
   Float_t         ScintHitPosX[996];   //[NScintHit]
   Float_t         ScintHitPosY[996];   //[NScintHit]
   Float_t         ScintHitPosZ[996];   //[NScintHit]
   Int_t           ScintHitStation[996];   //[NScintHit]
   Int_t           HitPDG[996];   //[NScintHit]
