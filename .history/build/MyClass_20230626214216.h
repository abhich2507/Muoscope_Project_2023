...
// Mon Jun 26 21:41:42 2023 by ROOT version 6.26/06
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         GenPartPhi;
   Int_t           NScintHit;
   Int_t           ScintHitPrimaryID[305];   //[NScintHit]
   Int_t           ScintHitTrackID[305];   //[NScintHit]
   Int_t           ScintHitTrackLength[305];   //[NScintHit]
   Float_t         ScintHitE[305];   //[NScintHit]
   Float_t         ScintHitPz[305];   //[NScintHit]
   Float_t         ScintHitPosX[305];   //[NScintHit]
   Float_t         ScintHitPosY[305];   //[NScintHit]
   Float_t         ScintHitPosZ[305];   //[NScintHit]
   Int_t           ScintHitStation[305];   //[NScintHit]
   Int_t           HitPDG[305];   //[NScintHit]
