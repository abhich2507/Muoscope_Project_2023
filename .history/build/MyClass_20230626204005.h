...
// Mon Jun 26 20:08:37 2023 by ROOT version 6.26/06
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           NScintHit;
   Int_t           ScintHitPrimaryID[308];   //[NScintHit]
   Int_t           ScintHitTrackID[308];   //[NScintHit]
   Int_t           ScintHitTrackLength[308];   //[NScintHit]
   Float_t         ScintHitE[308];   //[NScintHit]
   Float_t         ScintHitPz[308];   //[NScintHit]
   Float_t         ScintHitPosX[308];   //[NScintHit]
   Float_t         ScintHitPosY[308];   //[NScintHit]
   Float_t         ScintHitPosZ[308];   //[NScintHit]
   Int_t           ScintHitStation[308];   //[NScintHit]
   Int_t           HitPDG[308];   //[NScintHit]
