 ...
 */
   ...
   if (distance > 0.)
   {
      closestPoint.SetX(closestPoint1.X()+(closestPoint1.X() - closestPoint2.X()) / 2.);
      closestPoint.SetY(closestPoint1.Y()+(closestPoint1.Y() - closestPoint2.Y()) / 2.);
      closestPoint.SetZ(closestPoint1.Z()+(closestPoint1.Z() - closestPoint2.Z()) / 2.);
   }
   return closestPoint;
}
