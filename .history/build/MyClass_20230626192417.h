...
// Mon Jun 26 19:24:07 2023 by ROOT version 6.26/06
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           NScintHit;
   Int_t           ScintHitPrimaryID[117];   //[NScintHit]
   Int_t           ScintHitTrackID[117];   //[NScintHit]
   Int_t           ScintHitTrackLength[117];   //[NScintHit]
   Float_t         ScintHitE[117];   //[NScintHit]
   Float_t         ScintHitPz[117];   //[NScintHit]
   Float_t         ScintHitPosX[117];   //[NScintHit]
   Float_t         ScintHitPosY[117];   //[NScintHit]
   Float_t         ScintHitPosZ[117];   //[NScintHit]
   Int_t           ScintHitStation[117];   //[NScintHit]
   Int_t           HitPDG[117];   //[NScintHit]
