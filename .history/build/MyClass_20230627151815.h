...
// Tue Jun 27 15:18:02 2023 by ROOT version 6.26/06
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         GenPartPhi;
   Int_t           NScintHit;
   Int_t           ScintHitPrimaryID[429];   //[NScintHit]
   Int_t           ScintHitTrackID[429];   //[NScintHit]
   Int_t           ScintHitTrackLength[429];   //[NScintHit]
   Float_t         ScintHitE[429];   //[NScintHit]
   Float_t         ScintHitPz[429];   //[NScintHit]
   Float_t         ScintHitPosX[429];   //[NScintHit]
   Float_t         ScintHitPosY[429];   //[NScintHit]
   Float_t         ScintHitPosZ[429];   //[NScintHit]
   Int_t           ScintHitStation[429];   //[NScintHit]
   Int_t           HitPDG[429];   //[NScintHit]
