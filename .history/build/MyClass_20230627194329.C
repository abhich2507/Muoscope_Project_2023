...
vector<float> HE[4]= {HE0,HE1,HE2,HE3};
 ...
 TH1F* histAngle = new TH1F("histAngle","scattering angle",500,-.15,.15);
...
//yz plane
Vector3D v1yz(0,Sy[1][q]-Sy[0][q],Sz[1][q]-Sz[0][q]);
Vector3D v2yz(0,Sy[3][q]-Sy[2][q],Sz[3][q]-Sz[2][q]);
