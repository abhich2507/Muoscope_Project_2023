...
// Mon Jun 26 21:15:17 2023 by ROOT version 6.26/06
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         GenPartPhi;
   Int_t           NScintHit;
   Int_t           ScintHitPrimaryID[55];   //[NScintHit]
   Int_t           ScintHitTrackID[55];   //[NScintHit]
   Int_t           ScintHitTrackLength[55];   //[NScintHit]
   Float_t         ScintHitE[55];   //[NScintHit]
   Float_t         ScintHitPz[55];   //[NScintHit]
   Float_t         ScintHitPosX[55];   //[NScintHit]
   Float_t         ScintHitPosY[55];   //[NScintHit]
   Float_t         ScintHitPosZ[55];   //[NScintHit]
   Int_t           ScintHitStation[55];   //[NScintHit]
   Int_t           HitPDG[55];   //[NScintHit]
