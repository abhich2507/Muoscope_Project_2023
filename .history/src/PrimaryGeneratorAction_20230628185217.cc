...
return A*(B+C);
						   ...
						   
  {
    ...
    */
  fMuonGen.SetUseSky();
  fMuonGen.SetSkySize({{40.*cm, 40.*cm}});
  fMuonGen.SetSkyCenterPosition({{0., 0.,-2.*cm}});   
  //fMuonGen.SetDifferentialFlux(&J);
 fMuonGen.SetMaximumMomentum(5000.0000000000000001*keV);
   fMuonGen.SetMinimumMomentum(5000.*keV);
  
  fMuonGen.SetMinimumTheta(0.00);
  fMuonGen.SetMaximumTheta(0.000000000010);
...
void PrimaryGeneratorAction::GeneratePrimaries(G4Event* anEvent)
{
  ...
  */
 fParticleGun->SetParticleMomentum( G4ParticleMomentum(muon_ptot*GeV,
							0,
							0) );
