...
return A*(B+C);
  ...
  fMuonGen.SetUseSky();
  fMuonGen.SetSkySize({{50.*cm, 50.*cm}});
  fMuonGen.SetSkyCenterPosition({{0., 0.,-2.*cm}});   
  fMuonGen.SetDifferentialFlux(&J);
 // fMuonGen.SetMinimumMomentum(1000.0*MeV);
  //fMuonGen.SetMaximumMomentum(1000.0000000000000001*MeV);
  
  
  // fMuonGen.SetMinimumTheta(0.);
  //fMuonGen.SetMaximumTheta(0.0000000000000000000000000000000001);
 //fMuonGen.SetMinimumPhi(0.000);
  //fMuonGen.SetMaximumPhi(0.0000000000001);
...
void PrimaryGeneratorAction::GeneratePrimaries(G4Event* anEvent)
{
  ...
  fParticleGun->SetParticleMomentum( G4ParticleMomentum(muon_ptot*sin(muon_theta)*cos(muon_phi)*MeV,
							muon_ptot*sin(muon_theta)*sin(muon_phi)*MeV,
							muon_ptot*cos(muon_theta)*MeV) );

  
/*fParticleGun->SetParticleMomentum( G4ParticleMomentum(0.,
							0.,
							1.*muon_ptot*GeV) );
  */
