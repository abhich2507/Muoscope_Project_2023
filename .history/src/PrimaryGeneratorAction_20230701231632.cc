   ...
   fParticleGun(0)
{
  ...
  fParticleGun->SetParticleEnergy(4.5*GeV);
...
void PrimaryGeneratorAction::GeneratePrimaries(G4Event* anEvent)
{
  ...
  G4double xPos=(G4UniformRand()-0.5)*50*cm;
  G4double yPos=(G4UniformRand()-0.5)*50*cm;
  G4double zPos=(G4UniformRand()-0.5)*4*cm;

  fParticleGun->SetParticlePosition(G4ThreeVector(xPos,yPos,-2*cm+zPos));
  G4ThreeVector momentumUnitVector = {0,0,1};
