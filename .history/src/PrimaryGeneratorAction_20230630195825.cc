...
void PrimaryGeneratorAction::GeneratePrimaries(G4Event* anEvent)
{
  ...
  G4double xPos=(G4UniformRand()-0.5)*10*cm;
  G4double yPos=(G4UniformRand()-0.5)*10*cm;
  G4double zPos=(G4UniformRand()-0.5)*4*cm;

  fParticleGun->SetParticlePosition(G4ThreeVector(10*cm+xPos,-10*cm+yPos,-2*cm+zPos));
