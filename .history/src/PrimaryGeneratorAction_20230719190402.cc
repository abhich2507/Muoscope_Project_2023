...
return A*(B+C);
  ...
  fMuonGen.SetMinimumMomentum(4000.0*keV);
  fMuonGen.SetMaximumMomentum(4000.0000000000000001*keV);
...
void PrimaryGeneratorAction::GeneratePrimaries(G4Event* anEvent)
{
  ...
  fParticleGun->SetParticleMomentum( G4ParticleMomentum(muon_ptot*sin(muon_theta)*cos(muon_phi)*keV,
							muon_ptot*sin(muon_theta)*sin(muon_phi)*keV,
							muon_ptot*cos(muon_theta)*keV) );
