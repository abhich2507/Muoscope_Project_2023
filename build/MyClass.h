...
// Tue Aug 29 23:04:16 2023 by ROOT version 6.28/04
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           Event;
   Int_t           NScintHit;
   Int_t           ScintHitPrimaryID[71];   //[NScintHit]
   Int_t           ScintHitTrackID[71];   //[NScintHit]
   Int_t           ScintHitTrackLength[71];   //[NScintHit]
   Float_t         ScintHitE[71];   //[NScintHit]
   Float_t         ScintHitPz[71];   //[NScintHit]
   Float_t         ScintHitPosX[71];   //[NScintHit]
   Float_t         ScintHitPosY[71];   //[NScintHit]
   Float_t         ScintHitPosZ[71];   //[NScintHit]
   Int_t           ScintHitStation[71];   //[NScintHit]
   Int_t           HitPDG[71];   //[NScintHit]
